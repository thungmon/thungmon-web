        ...
        <div className="mx-auto max-w-3xl px-6 py-16">
          <div className="mb-10 flex items-center justify-end gap-4">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#1877F2] p-2 text-sm font-medium text-white transition-opacity hover:opacity-90 sm:px-4 sm:py-2"
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#06C755] p-2 text-sm font-medium text-white transition-opacity hover:opacity-90 sm:px-4 sm:py-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              ...
              <span className="hidden sm:inline">แชร์ไปยัง Line</span>
            </a>
          </div>
          {/* ─── Description ─── */}
          <section>
